...
public class Auto extends DriveTrain {
    ...
    static final double INCHES_FROM_GOAL = -20; //distance from starting  position to "C" wobble goal dropoff
    ...
    public void runOpMode() {
        ...
        encoderDrive(0.8, INCHES_FROM_GOAL, INCHES_FROM_GOAL, INCHES_FROM_GOAL, INCHES_FROM_GOAL, 10);
